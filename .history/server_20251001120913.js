...
// Start server - use explicit host binding
try {
  // Explicitly bind to localhost instead of all interfaces
  ...
  server.on('error', (err) => {
    ...
    if (err.code === 'EADDRINUSE') {
      ...
      const altServer = app.listen(3002, 'localhost', () => {
        console.log(`Server running on alternative port: http://localhost:3002`);
