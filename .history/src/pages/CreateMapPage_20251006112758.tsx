    ...
    <div style={{ minHeight: '100vh', width: '100vw', background: '#f5f5f5' }}>
      ...
      <div style={{ display: 'flex', height: 'calc(100vh - 56px)', position: 'relative' }}>
        ...
        <div style={{
          ...
          <button style={{ background: 'none', border: 'none', fontSize: '1.3em', cursor: 'pointer', color: '#4f8cff' }} title="Draw"><span>&#9998;</span></button>
          <button style={{ background: 'none', border: 'none', fontSize: '1.3em', cursor: 'pointer', color: '#4f8cff' }} title="Search"><span>&#128269;</span></button>
          <button style={{ background: 'none', border: 'none', fontSize: '1.3em', cursor: 'pointer', color: '#4f8cff' }} title="Add Marker"><span>&#128392;</span></button>
          <span style={{ flex: 1 }}></span>
          <input type="text" placeholder="Search..." value={search} onChange={e => setSearch(e.target.value)} style={{ borderRadius: 6, border: '1px solid #ccc', padding: '6px 12px', fontSize: '1em', width: 180 }} />
          <button style={{ background: '#4f8cff', color: '#fff', border: 'none', borderRadius: 6, padding: '6px 16px', fontWeight: 600, fontSize: '1em', cursor: 'pointer' }}>+ New</button>
        </div>
