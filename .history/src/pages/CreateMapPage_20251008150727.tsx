  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', background: '#f5f5f5', position: 'relative', color: '#000' }}>
      ...
      <div style={{ width: '100%', maxWidth: 600, margin: '0 auto', background: '#fff', borderRadius: '18px', boxShadow: '0 4px 24px rgba(120,120,120,0.10)', padding: '40px 32px', marginTop: '32px', marginBottom: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <h2 style={{ marginBottom: '32px', color: '#000', fontWeight: 700, fontSize: '2em' }}>Map Details</h2>
        
        <div style={{ width: '100%', marginBottom: '20px' }}>
          <label style={{ fontWeight: '500', marginBottom: '5px', display: 'block' }}>Map Title</label>
          <div style={{ 
            fontSize: '1.1em', 
            padding: '10px', 
            borderRadius: '6px', 
        ...
        <div style={{ width: '100%', marginBottom: '20px' }}>
          <label style={{ fontWeight: '500', marginBottom: '5px', display: 'block' }}>Map Description</label>
          <div style={{ 
            fontSize: '1em', 
            padding: '10px', 
            borderRadius: '6px', 
            ...
            {mapDescription || <em style={{ color: '#888' }}>No description provided</em>}
          </div>
          <button 
            style={{ 
              background: 'none', 
