...
const CreateMapPage: React.FC = () => {
  ...
  // Add search handler function for the sidebar
  const handleSearch = (lat: number, lng: number, zoom: number, cities?: any[], countryName?: string) => {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', background: '#f5f5f5', position: 'relative' }}>
      ...
      <div style={{ width: '100%', minHeight: 400, borderRadius: '18px', overflow: 'hidden', boxShadow: '0 4px 24px rgba(120,120,120,0.10)', background: '#fff', marginBottom: '32px', position: 'relative' }}>
        <WorldMap 
          lat={mapPosition.lat} 
          lng={mapPosition.lng} 
