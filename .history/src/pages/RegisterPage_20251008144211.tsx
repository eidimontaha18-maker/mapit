...
import { getApiCandidates } from '../utils/env';
...
// Use only port 3101 for Express server (explicitly, no candidates)
const API_CANDIDATES = ['http://127.0.0.1:3101', 'http://localhost:3101'];
console.log('RegisterPage loaded. API base:', API_CANDIDATES[0]);
