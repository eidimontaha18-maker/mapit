      ...
      {loading ? (
        ...
        <>
          ...
          <MapTypeSelector
            ...
            onMapTypeChange={(type) => setMapType(type as 'road' | 'satellite' | 'hybrid' | 'terrain')}
          />
          ...
          <div style={{
            position: 'fixed',
            top: '70px',
            [sidebarPosition === 'right' ? 'right' : 'left']: sidebarOpen ? '380px' : '20px',
            display: 'flex',
            ...
            >
              {sidebarOpen ? (sidebarPosition === 'right' ? '→' : '←') : (sidebarPosition === 'right' ? '←' : '→')}
            </button>
            ...
            <button
              ...
              onMouseOver={(e) => {
                e.currentTarget.style.background = '#2d8f47';
                e.currentTarget.style.transform = 'scale(1.05)';
              }}
              onMouseOut={(e) => {
