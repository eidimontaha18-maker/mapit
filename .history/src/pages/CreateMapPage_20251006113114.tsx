...
const CreateMapPage: React.FC = () => {
  ...
  // Remove sidebarOpen and search, restore top sidebar layout
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', background: '#f5f5f5' }}>
      ...
      <div style={{ width: '100%', minHeight: 400, borderRadius: '18px', overflow: 'hidden', boxShadow: '0 4px 24px rgba(120,120,120,0.10)', background: '#fff', marginBottom: '32px' }}>
