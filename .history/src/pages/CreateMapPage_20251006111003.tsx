...
const CreateMapPage: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', background: 'linear-gradient(135deg, #e3eafc 0%, #b6d0f7 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ maxWidth: 420, width: '100%', background: '#fff', borderRadius: '18px', boxShadow: '0 4px 24px rgba(120,120,120,0.10)', padding: '40px 32px', margin: '32px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ width: '100%', maxWidth: 900, minHeight: 400, borderRadius: '18px', overflow: 'hidden', boxShadow: '0 4px 24px rgba(120,120,120,0.10)', background: '#fff', marginBottom: '32px' }}>
