...
const CountrySidebar: React.FC<CountrySidebarProps> = ({ onSearch, onLanguageChange }) => {
  ...
  // Helper: get cities for selected country
  function getCitiesForCountry(country: string) {
    // Example: cities have a 'country' field matching country name
    return Object.keys(allCities).filter(city => allCities[city].country === country);
  }
  ...
  return (
    <aside className="country-sidebar">
      ...
      <div className="sidebar-search">
        <select value={selectedCountry} onChange={handleCountryChange} className="sidebar-input">
