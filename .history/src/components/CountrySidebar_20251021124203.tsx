    ...
    try {
      ...
      allData.forEach(data => {
        ...
        data.forEach((item: any) => {
          // IMPORTANT: Verify the city is actually in the requested country
          ...
          if (!itemCountry || 
            ...
            // Additional check: if the display_name contains the country name, it might still be valid
          ...
          if (cityName && 
            ...
            console.log(`✅ Added city: ${cityName} in ${countryName}`);
          }
        });
      });
