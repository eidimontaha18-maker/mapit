...
const PolygonDrawingControl = ({ 
  ...
  const layer = drawEvent.layer;
      ...
      // Note: We don't add this layer to the drawing layer permanently
      // The ZonesDisplay component will handle the persistent display
      // Just temporary styling for immediate feedback
