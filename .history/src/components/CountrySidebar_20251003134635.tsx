...
const CountrySidebar: React.FC<CountrySidebarProps> = ({ onSearch }) => {
  ...
  const handleSearch = () => {
    ...
    if (countryKey) {
      ...
      // Move map to country position and show all city markers with closer zoom
      onSearch(lat, lng, 8, cityMarkers, countryKey);
      return;
    }
                ...
                <div 
                  ...
                  onClick={() => {
                    ...
                    if (cityData) {
                      ...
                      // Zoom in closer to the selected city but show all markers
                      onSearch(cityData.lat, cityData.lng, 13, cityMarkers, selectedCountry);
                    }
                  }}
                >
                  {city}
