  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', height: 'calc(100vh - 64px)' }}>
        <CountrySidebar onSearch={handleCountrySearch} onLanguageChange={handleLanguageChange} />
        <div style={{ flex: 1 }}>
          <WorldMap lat={mapState.lat} lng={mapState.lng} zoom={mapState.zoom} language={language} />
        </div>
      </div>
    </div>
  );
