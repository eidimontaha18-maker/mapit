 ...
 * @returns {Promise<Array<any>>} Array of rows
 */
export async function getAll(tableName: string, orderBy?: string): Promise<any[]> {
  try {
 ...
 * @returns {Promise<any>} The row object or null if not found
 */
 ...
 * @param {string} idColumn - Name of the ID column (defaults to 'id')
 * @returns {Promise<any>} The updated row
 */
